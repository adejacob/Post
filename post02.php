...
<body>
	<div class="container">
		<a href="post.php?id=<?php echo $jacob['id']; ?> " class="btn btn-default">back</a>
	<h1><?php echo $jacob['title']; ?></h1>
			...
			<a href="editpost.php?id=<?php echo $jacob['id']; ?>" class="btn btn-default">Edit</a>
</div>
